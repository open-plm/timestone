...
type ProgramControllerForPrivate interface {
...
type programControllerForPrivate struct {
	ProgramRepository repository.ProgramRepository
}

func (programController programControllerForPrivate) GetPrograms(c *gin.Context) {
...
func (programController programControllerForPrivate) CreateProgram(c *gin.Context) {
	var programRequest request.ProgramRequest
	if err := c.Bind(&programRequest); err != nil {
...
func (programController programControllerForPrivate) UpdateProgram(c *gin.Context) {
	var programRequest request.ProgramRequest
	if err := c.Bind(&programRequest); err != nil {
...
func (programController programControllerForPrivate) DeleteProgram(c *gin.Context) {
	var programRequest request.ProgramRequest
	if err := c.Bind(&programRequest); err != nil {
...
func NewProgramControllerForPrivate(programRepository repository.ProgramRepository) ProgramControllerForPrivate {
	return &programControllerForPrivate{ ProgramRepository: programRepository}
}