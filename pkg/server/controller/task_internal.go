...
type TaskControllerForInternal interface {
...
type taskControllerForInternal struct {
	TaskRepository repository.TaskRepository
}

func (taskController taskControllerForInternal) GetTasks(c *gin.Context) {
...
func (taskController taskControllerForInternal) CreateTask(c *gin.Context) {
	var taskRequest request.TaskRequest
	if err := c.Bind(&taskRequest); err != nil {
...
func (taskController taskControllerForInternal) UpdateTask(c *gin.Context) {
	var taskRequest request.TaskRequest
	if err := c.Bind(&taskRequest); err != nil {
...
func (taskController taskControllerForInternal) DeleteTask(c *gin.Context) {
	var taskRequest request.TaskRequest
	if err := c.Bind(&taskRequest); err != nil {
...
func NewTaskControllerForInternal(taskRepository repository.TaskRepository) TaskControllerForInternal {
	return &taskControllerForInternal{ TaskRepository: taskRepository}
}